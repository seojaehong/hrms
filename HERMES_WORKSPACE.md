...
- Gate 14 credential apply checkpoint result:
  ...
  - 2026-05-17 cron test evidence on `23d104927`: `python3 hrms/tests/test_korea_browser_credential_apply_checkpoint.py` passed 14 tests, and `node frontend/tests/koreaPayrollClosingBrowserRuntime.test.mjs` passed.
