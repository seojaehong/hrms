...
- Gate 14 credential apply checkpoint result:
  ...
  - 2026-05-17 cron test evidence on `c1b12a78d`: `node frontend/tests/koreaPayrollClosingBrowserRuntime.test.mjs` passed, and `python3 hrms/tests/test_korea_browser_credential_apply_checkpoint.py` passed 12 tests.
