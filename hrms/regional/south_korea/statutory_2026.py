...
출처 및 적용 기준:
  - 국민연금: 2026년 요율 각 4.75% (연금개혁 단계인상, §88③·published 노드 국민연금요율_2026). 상한 6,590,000 / 하한 410,000 (고시 제2026-31호, 2026.7분~, 매년 7월 갱신 — published 노드 국민연금상한/하한_2026)
...
PENSION_MIN_BASE: int = 410_000   # 기준소득월액 하한 (고시 제2026-31호, 2026.7분~2027.6분)
PENSION_MAX_BASE: int = 6_590_000  # 기준소득월액 상한 (고시 제2026-31호, 2026.7분~2027.6분)
