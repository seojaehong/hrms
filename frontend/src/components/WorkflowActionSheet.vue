<template>
	<div
		...
		:class="[
			props.view === 'form'
				? 'px-4 pt-4 pb-4 standalone:pb-safe-bottom sm:w-96 md:w-[44rem] xl:w-[64rem] 2xl:w-[76rem] mx-auto bg-white sticky bottom-0 w-full drop-shadow-xl z-40 border-t rounded-t-lg'
