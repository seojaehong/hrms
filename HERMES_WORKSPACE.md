...
- Gate 14 credential apply checkpoint result:
  ...
  - 2026-05-17 cron test evidence on `73c9c639b`: `node frontend/tests/koreaPayrollClosingBrowserRuntime.test.mjs` passed, and `python3 hrms/tests/test_korea_browser_credential_apply_checkpoint.py` passed 13 tests.
