<template>
	<div class="flex flex-col w-full">
		<div class="flex flex-row justify-between items-center px-4">
			<div class="k-t-title text-gray-800">{{ __("Leave Balance") }} </div>
			<router-link
		...
		>
			<div
				...
				:key="leave_type"
				class="flex flex-col bg-[var(--k-card)] border-none rounded-lg drop-shadow-md gap-2 p-4 items-start first:ml-4"
			>
				<SemicircleChart
