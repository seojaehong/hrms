...
app_logo_url = "/assets/hrms/images/safeclaw-hr-logo.svg"
app_home = "/hrms"

add_to_apps_screen = [
	{
		"name": "hrms",
		"logo": "/assets/hrms/images/safeclaw-hr-mark.svg",
		"title": "SafeClaw HR",
		"route": "/hrms",
...
doc_events = {
	...
	"Employee": {
		"validate": [
			...
			"hrms.regional.south_korea.employee_rrn.derive_rrn_masked",
		],
		"on_update": [
